...
<div class="post-list post-content-list">
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<div class="post-wrapper">
			<?php charitywp_post_featured_header( $post_id = get_the_ID() ); ?>
			...
			?>
				<div class="post-content-footer">
					<?php
						...
						wp_link_pages(
							array(
								'before' => '<div class="post-page-wrapper"><span class="post-page-wrapper-title">' . esc_html__( 'Pages:', 'charitywp' ) . '</span>',
								'after' => '</div>',
								'link_before' => '<span>',
								'link_after' => '</span>',
							)
						...
						if ( !$post_post_share_buttons == 'off' or $post_post_share_buttons == 'on' ) {
							echo charitywp_general_post_social_share();
						}

						if ( !$post_post_tags == 'off' or $post_post_tags == 'on' ) {
							$tags_title = esc_html__( 'Tags:', 'charitywp' );
